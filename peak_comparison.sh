...
bedtools intersect -a $MEF_K -b $ESC_K -u > $folder/KLF4_intersect.bed 
#cMyc peak overlaps between between MEF and ESC
bedtools intersect -a $MEF_M -b $ESC_M -u > $folder/cMyc_intersect.bed 
...
bedtools intersect -a $MEF_K -b $MEF_M -u > $folder/MEF_K_M_intersect.bed
#shared peaks between Oct4 and SOX2 in ESC
bedtools intersect -a $ESC_O -b $ESC_S -u > $folder/ESC_O_S_intersect.bed
#shared peaks between Oct4 and KLF4 in ESC
bedtools intersect -a $ESC_O -b $ESC_K -u > $folder/ESC_O_K_intersect.bed
#shared peaks between Oct4 and cMyc in ESC
bedtools intersect -a $ESC_O -b $ESC_M -u > $folder/ESC_O_M_intersect.bed
#shared peaks between SOX2 and KLF4 in ESC
bedtools intersect -a $ESC_S -b $ESC_K -u > $folder/ESC_S_K_intersect.bed
#shared peaks between SOX2 and cMyc in ESC
bedtools intersect -a $ESC_S -b $ESC_M -u > $folder/ESC_S_M_intersect.bed
#shared peaks between KLF4 and cMyc in ESC
bedtools intersect -a $ESC_K -b $ESC_M -u > $folder/ESC_K_M_intersect.bed

#shared peaks between Oct4, SOX2 and KLF4 in ESC
bedops --merge $ESC_O $ESC_S | awk '($3-$2) > 201' > $folder/ESC_O_S_merged.bed
bedtools intersect -a $folder/ESC_O_S_merged.bed -b $ESC_K -u > $folder/ESC_O_S_K_intersect.bed
#shared peaks between Oct4, SOX2 and cMyc in ESC
bedtools intersect -a $folder/ESC_O_S_merged.bed -b $ESC_M -u > $folder/ESC_O_S_M_intersect.bed
#shared peaks between SOX2, KLF4 and cMyc in ESC
bedops --merge $ESC_S $ESC_K | awk '($3-$2) > 201' > $folder/ESC_S_K_merged.bed
bedtools intersect -a $folder/ESC_S_K_merged.bed -b $ESC_M -u > $folder/ESC_S_K_M_intersect.bed
#shared peaks between Oct4, KLF4 and cMyc in ESC
bedops --merge $ESC_O $ESC_K | awk '($3-$2) > 201' > $folder/ESC_O_K_merged.bed
bedtools intersect -a $folder/ESC_O_K_merged.bed -b $ESC_M -u > $folder/ESC_O_K_M_intersect.bed
#shared peaks between all TFs in ESC
bedops --merge $folder/ESC_O_S_merged.bed $ESC_K | awk '($3-$2) > 201' >$folder/ESC_O_S_K_merged.bed
bedtools intersect -a $folder/ESC_O_S_K_merged.bed -b $ESC_M -u > $folder/ESC_all_intersect.bed
